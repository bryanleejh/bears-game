var Player2 = function(settings, playerX, playerY) {
    ...
    var cannonPower = 0;
    var adjustedAngle = 0;
    var bulletOriginFromBot = settings.player2pos.y + 50; //settings.playerYpos + 50
    var bulletOriginFromLeft = settings.player2pos.x + 20; //settings.playerYpos + 50
    ...
    function move(interactions){
      ...
      //move player left
      if(interactions.z) {
        settings.player2pos.x = settings.player2pos.x - 1;
        cannonElement.style.left = settings.player2pos.x + 15 + 'px';
        playerElement.style.left = settings.player2pos.x + 'px';
      }
    ...
    function create() {
      ...
      cannonElement.style.bottom = settings.player2pos.y + 25 + 'px'; //settings.playerXpos + 25 + px //25px
      cannonElement.style.left = settings.player2pos.x + 15 + 'px'; //settings.playerYpos + 15 + px //115px
      ...
      playerElement.style.bottom = settings.player2pos.y + 'px'; //settings.playerXpos + 'px' //0px
      playerElement.style.left = settings.player2pos.x + 'px'; //settings.playerYpos + 'px' //100px
      playerElement.style.height = '50px';
      playerElement.style.width = '50px';
      bulletOriginFromBot = settings.player2pos.y + 50; //settings.playerYpos + 50
      bulletOriginFromLeft = settings.player2pos.x + 20; //settings.playerXpos + 20
    }

    function fire() {
      settings.bulletActive = true;
      var bullet2 = new Bullet2(settings,(settings.player2pos.x + 20),
        (settings.player2pos.y + 50),cannonPower,adjustedAngle);
